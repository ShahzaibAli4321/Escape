...
//        if (!isChasing)
//        {
//            // If player enters detection radius
//            if (distance <= detectionRadius && !playerSpotted)
//            {
...
//            // If player leaves detection radius before delay finishes
...
public class Enemy : MonoBehaviour
{
    ...
    [Header("Detection Settings")]
    public float detectionRadius = 20f;   // how far the enemy can "see"
    [Range(0, 360)]
